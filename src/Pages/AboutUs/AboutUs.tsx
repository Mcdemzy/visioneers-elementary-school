        ...
        <div className="flex flex-col gap-y-10 lg:flex-row justify-start items-center gap-x-[72px] m-auto w-[90%] mt-10 md:mt-20">
          <div className="space-y-[40px] w-full lg:w-[50%]">
            ...
            <p className="text-sm md:text-[16px] text-[#333333] font-Inter leading-[26px]">
              ...
              nurture young minds to reach their full potential. Join the
              Visioneers family for an exciting educational journey filled with
              growth and endless possibilities.
            </p>
            <button className="bg-[#8D0E4E] text-white rounded-[4px] w-[166px] h-[51px] text-[16px] font-[500]">
              Contact Us
            </button>
          </div>
      ...
      <div className="mt-10 md:mt-24 w-full">
        ...
        <div className="flex flex-col gap-y-10 lg:flex-row justify-start items-center gap-x-[72px] m-auto w-[90%] mt-10 md:mt-20">
          <div className="space-y-[40px] w-full lg:w-[50%]">
            ...
            <p className="text-sm md:text-[16px] text-[#000000] font-Inter leading-[26px]">
