...
export default function ProfilePictureUpload({
  ...
  const handleDownload = () => {
    ...
    link.href = "/Visioneers Elementary School 2025 reg form.pdf";
    link.download = "Visioneers Elementary School 2025 reg form.pdf";
      ...
      <div className="w-full flex flex-col items-center md:items-end">
        ...
        <section className="w-auto">
          <button
            ...
            className="flex items-center justify-center gap-2 bg-primary hover:bg-[#57007B] text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200 w-full md:w-auto"
          >
            <Download size={20} />
